...
import (
	...
	"github.com/CratD2C-SmartChain/cratd2cchain/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic CRAT metadata
	fmt.Fprintf(c.printer, "Welcome to the CRAT JavaScript console!\n\n")
	c.jsre.Run(`
