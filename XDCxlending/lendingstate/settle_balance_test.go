...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"LendToken is CRAT, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not CRAT, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not CRAT, no error, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not CRAT, no error, taker INVEST",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is CRAT, no error, taker invest",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is CRAT, no error, taker Borrow",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
