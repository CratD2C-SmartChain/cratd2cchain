...
func Test_getCancelFee(t *testing.T) {
	...
	tests := []struct {
		...
		// zero fee test: BORROW
		{
			"TokenA/CRAT zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee: LEND
		{
			"TokenA/CRAT test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee:: BORROW
		{
			"TokenA/CRAT test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// zero fee test: LEND
		{
			"CRAT/TokenA zero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
		...
		// zero fee test: BORROW
		{
			"CRAT/TokenA zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.XDCNativeAddress),
		...
		// test getCancelFee: LEND
		{
			"CRAT/TokenA  test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.XDCNativeAddress),
		...
		// test getCancelFee:: BORROW
		{
			"CRAT/TokenA  test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.XDCNativeAddress),
	...
	// testcase: can't get price of token in CRAT
