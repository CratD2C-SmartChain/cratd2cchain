...
import (
	...
	"github.com/CratD2C-SmartChain/cratd2cchain/common/countdown"
	"github.com/CratD2C-SmartChain/cratd2cchain/consensus"
	"github.com/CratD2C-SmartChain/cratd2cchain/consensus/CratD2C/utils"
	"github.com/CratD2C-SmartChain/cratd2cchain/consensus/clique"
...
type CratD2C_v2 struct {
	...
	// lockQuorumCert in CratD2C Consensus 2.0, used in voting rule
	...
	HookPenalty func(chain consensus.ChainReader, number *big.Int, parentHash common.Hash, candidates []common.Address, config *params.CratD2CConfig) ([]common.Address, error)
...
func New(chainConfig *params.ChainConfig, db ethdb.Database, minePeriodCh chan int) *CratD2C_v2 {
...
func (x *CratD2C_v2) UpdateParams(header *types.Header) {
...
func (x *CratD2C_v2) UpdateSkipV2Validation(skip bool) {
...
*/
func (x *CratD2C_v2) SignHash(header *types.Header) (hash common.Hash) {
	return sigHash(header)
}

// Initial V2 related parameters
func (x *CratD2C_v2) Initial(chain consensus.ChainReader, header *types.Header) error {
...
func (x *CratD2C_v2) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (bool, error) {
	x.lock.RLock()
...
func (x *CratD2C_v2) Prepare(chain consensus.ChainReader, header *types.Header) error {
...
func (x *CratD2C_v2) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, parentState *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	// set block reward
...
func (x *CratD2C_v2) Authorize(signer common.Address, signFn clique.SignerFn) {
	x.signLock.Lock()
...
func (x *CratD2C_v2) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, x.signatures)
}

// Seal implements consensus.Engine, attempting to create a sealed block using
// the local signing credentials.
func (x *CratD2C_v2) Seal(chain consensus.ChainReader, block *types.Block, stop <-chan struct{}) (*types.Block, error) {
	header := block.Header()
...
// current signer.
func (x *CratD2C_v2) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
	return x.calcDifficulty(chain, parent, x.signer)
}

func (x *CratD2C_v2) IsAuthorisedAddress(chain consensus.ChainReader, header *types.Header, address common.Address) bool {
...
func (x *CratD2C_v2) GetSnapshot(chain consensus.ChainReader, header *types.Header) (*SnapshotV2, error) {
	number := header.Number.Uint64()
...
func (x *CratD2C_v2) UpdateMasternodes(chain consensus.ChainReader, header *types.Header, ms []utils.Masternode) error {
	number := header.Number.Uint64()
...
func (x *CratD2C_v2) VerifyHeader(chain consensus.ChainReader, header *types.Header, fullVerify bool) error {
...
func (x *CratD2C_v2) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, fullVerifies []bool, abort <-chan struct{}, results chan<- error) {
	go func() {
...
func (x *CratD2C_v2) VerifySyncInfoMessage(chain consensus.ChainReader, syncInfo *types.SyncInfo) (bool, error) {
	/*
...
func (x *CratD2C_v2) SyncInfoHandler(chain consensus.ChainReader, syncInfo *types.SyncInfo) error {
	x.lock.Lock()
	defer x.lock.Unlock()
	/*
		1. processQC
...
Vote workflow
*/
func (x *CratD2C_v2) VerifyVoteMessage(chain consensus.ChainReader, vote *types.Vote) (bool, error) {
	/*
...
func (x *CratD2C_v2) VoteHandler(chain consensus.ChainReader, voteMsg *types.Vote) error {
	x.lock.Lock()
	defer x.lock.Unlock()
...
/*
	  ...
	  2. Check signature:
		...
		3. Broadcast(Not part of consensus)
*/
func (x *CratD2C_v2) VerifyTimeoutMessage(chain consensus.ChainReader, timeoutMsg *types.Timeout) (bool, error) {
...
*/
func (x *CratD2C_v2) TimeoutHandler(blockChainReader consensus.ChainReader, timeout *types.Timeout) error {
	x.lock.Lock()
	defer x.lock.Unlock()
...
*/
func (x *CratD2C_v2) ProposedBlockHandler(chain consensus.ChainReader, blockHeader *types.Header) error {
	x.lock.Lock()
	defer x.lock.Unlock()
...
func (x *CratD2C_v2) VerifyBlockInfo(blockChainReader consensus.ChainReader, blockInfo *types.BlockInfo, blockHeader *types.Header) error {
	/*
...
func (x *CratD2C_v2) verifyQC(blockChainReader consensus.ChainReader, quorumCert *types.QuorumCert, parentHeader *types.Header) error {
	/*
...
func (x *CratD2C_v2) processQC(blockChainReader consensus.ChainReader, incomingQuorumCert *types.QuorumCert) error {
...
*/
func (x *CratD2C_v2) setNewRound(blockChainReader consensus.ChainReader, round types.Round) {
...
func (x *CratD2C_v2) broadcastToBftChannel(msg interface{}) {
	go func() {
		x.BroadcastCh <- msg
	}()
}

func (x *CratD2C_v2) getSyncInfo() *types.SyncInfo {
...
func (x *CratD2C_v2) commitBlocks(blockChainReader consensus.ChainReader, proposedBlockHeader *types.Header, proposedBlockRound *types.Round, incomingQc *types.QuorumCert) (bool, error) {
	// CratD2C v1.0 switch to v2.0, skip commit
...
func (x *CratD2C_v2) GetMasternodesFromEpochSwitchHeader(epochSwitchHeader *types.Header) []common.Address {
...
func (x *CratD2C_v2) GetMasternodes(chain consensus.ChainReader, header *types.Header) []common.Address {
...
// Given header, get master node from the epoch switch block of that epoch
func (x *CratD2C_v2) GetPenalties(chain consensus.ChainReader, header *types.Header) []common.Address {
	epochSwitchInfo, err := x.getEpochSwitchInfo(chain, header, header.Hash())
	if err != nil {
...
func (x *CratD2C_v2) GetStandbynodes(chain consensus.ChainReader, header *types.Header) []common.Address {
	epochSwitchInfo, err := x.getEpochSwitchInfo(chain, header, header.Hash())
	if err != nil {
...
func (x *CratD2C_v2) calcMasternodes(chain consensus.ChainReader, blockNum *big.Int, parentHash common.Hash) ([]common.Address, error) {
...
func (x *CratD2C_v2) GetMasternodesByHash(chain consensus.ChainReader, hash common.Hash) []common.Address {
...
func (x *CratD2C_v2) FindParentBlockToAssign(chain consensus.ChainReader) *types.Block {
...
func (x *CratD2C_v2) allowedToSend(chain consensus.ChainReader, blockHeader *types.Header, sendType string) bool {
...
func (x *CratD2C_v2) GetLatestCommittedBlockInfo() *types.BlockInfo {
