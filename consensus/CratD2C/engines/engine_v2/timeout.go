...
In the engine v2, we will need to:
 ...
 3. generateSyncInfo()
*/
func (x *CratD2C_v2) onTimeoutPoolThresholdReached(blockChainReader consensus.ChainReader, pooledTimeouts map[common.Hash]utils.PoolObj, currentTimeoutMsg utils.PoolObj, gapNumber uint64) error {
...
func (x *CratD2C_v2) verifyTC(chain consensus.ChainReader, timeoutCert *types.TimeoutCert) error {
	/*
...
*/
func (x *CratD2C_v2) processTC(blockChainReader consensus.ChainReader, timeoutCert *types.TimeoutCert) error {
...
*/
func (x *CratD2C_v2) sendTimeout(chain consensus.ChainReader) error {
...
*/
func (x *CratD2C_v2) OnCountdownTimeout(time time.Time, chain interface{}) error {
	x.lock.Lock()
	defer x.lock.Unlock()
...
func (x *CratD2C_v2) hygieneTimeoutPool() {
	x.lock.RLock()
	currentRound := x.currentRound
	x.lock.RUnlock()
...
func (x *CratD2C_v2) ReceivedTimeouts() map[string]map[common.Hash]utils.PoolObj {
