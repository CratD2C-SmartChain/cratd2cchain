...
func (x *CratD2C_v2) verifyHeader(chain consensus.ChainReader, header *types.Header, parents []*types.Header, fullVerify bool) error {
	...
	if x.IsGapPlusOneBlock(header) {
		validatorsAddress := header.NextValidators
