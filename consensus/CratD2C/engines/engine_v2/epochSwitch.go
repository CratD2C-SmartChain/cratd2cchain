...
func (x *CratD2C_v2) getEpochSwitchInfo(chain consensus.ChainReader, header *types.Header, hash common.Hash) (*types.EpochSwitchInfo, error) {
...
func (x *CratD2C_v2) isEpochSwitchAtRound(_ types.Round, parentHeader *types.Header) (bool, uint64, error) {
...
func (x *CratD2C_v2) GetCurrentEpochSwitchBlock(chain consensus.ChainReader, blockNum *big.Int) (uint64, uint64, error) {
...
func (x *CratD2C_v2) IsEpochSwitch(header *types.Header) (bool, uint64, error) {
	// in subnet, epoch switch block is whose block num % Epoch == 0
