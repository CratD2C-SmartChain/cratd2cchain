...
func (x *CratD2C_v2) signSignature(signingHash common.Hash) (types.Signature, error) {
...
func (x *CratD2C_v2) verifyMsgSignature(signedHashToBeVerified common.Hash, signature types.Signature, masternodes []common.Address) (bool, common.Address, error) {
...
func (x *CratD2C_v2) getExtraFields(header *types.Header) (*types.QuorumCert, types.Round, []common.Address, error) {
...
func (x *CratD2C_v2) GetRoundNumber(header *types.Header) (types.Round, error) {
