...
func (h Header) MarshalJSON() ([]byte, error) {
	type Header struct {
		...
		NextValidators []common.Address `json:"nextValidators"   gencodec:"required"`
	...
	enc.NextValidators = h.NextValidators
...
func (h *Header) UnmarshalJSON(input []byte) error {
	...
	if dec.NextValidators == nil {
		return errors.New("missing required field 'nextValidators' for Header")
	}
	h.NextValidators = dec.NextValidators
