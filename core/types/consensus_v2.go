...
// Round number type in CratD2C 2.0
type Round uint64
type Signature []byte

// Block Info struct in CratD2C 2.0, used for vote message, etc.
...
// Timeout message in CratD2C 2.0
type Timeout struct {
	signer    common.Address
	Round     Round
	Signature Signature
...
// BFT Sync Info message in CratD2C 2.0
...
// Quorum Certificate struct in CratD2C 2.0
...
// Timeout Certificate struct in CratD2C 2.0
...
// The parsed extra fields in block header in CratD2C 2.0 (excluding the version byte)
...
// Encode CratD2C 2.0 extra fields into bytes
