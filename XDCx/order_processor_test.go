...
func Test_getCancelFee(t *testing.T) {
	...
	tests := []struct {
		...
		// zero fee test: SELL
		{
			"TokenA/CRAT zero fee test: SELL",
			CancelFeeArg{
				feeRate: common.Big0,
				order: &tradingstate.OrderItem{
		...
		// test getCancelFee: SELL
		{
			"TokenA/CRAT test getCancelFee:: SELL",
			CancelFeeArg{
				feeRate: new(big.Int).SetUint64(10), // 10/10000= 0.1%
				order: &tradingstate.OrderItem{
		...
		// test getCancelFee:: BUY
		{
			"TokenA/CRAT test getCancelFee:: BUY",
			CancelFeeArg{
				feeRate: new(big.Int).SetUint64(10), // 10/10000= 0.1%
				order: &tradingstate.OrderItem{
					Quantity:   new(big.Int).SetUint64(10000),
		...
		// zero fee test: SELL
		{
			"CRAT/TokenA zero fee test: SELL",
			CancelFeeArg{
				feeRate: common.Big0,
				order: &tradingstate.OrderItem{
					BaseToken:  common.HexToAddress(common.XDCNativeAddress),
		...
		// test getCancelFee: SELL
		{
			"CRAT/TokenA test getCancelFee:: SELL",
			CancelFeeArg{
				feeRate: new(big.Int).SetUint64(10), // 10/10000= 0.1%
				order: &tradingstate.OrderItem{
					BaseToken:  common.HexToAddress(common.XDCNativeAddress),
		...
		// test getCancelFee:: BUY
		{
			"CRAT/TokenA test getCancelFee:: BUY",
			CancelFeeArg{
				feeRate: new(big.Int).SetUint64(10), // 10/10000= 0.1%
				order: &tradingstate.OrderItem{
					Quantity:   new(big.Int).SetUint64(10000),
