...
import (
	...
	bzzapi "github.com/CratD2C-SmartChain/cratd2cchain/swarm/api"
	swarmmetrics "github.com/CratD2C-SmartChain/cratd2cchain/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//CRAT only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for CRAT and swarm
