...
func (w *wizard) makeGenesis() {
	...
	fmt.Println()
	fmt.Println("Consensus engine = CratD2C")
	...
	genesis.Config.CratD2C.NetworkName = w.readDefaultString("xdc-subnet")

	fmt.Println()
	fmt.Println("What's the name of the chain denomination? (default = 0x)")
	genesis.Config.CratD2C.Denom = w.readDefaultString("0x")
	...
	genesis.Config.CratD2C.FoudationWalletAddr = w.readDefaultAddress(grandMasters[0])
