...
import (
	...
	"github.com/CratD2C-SmartChain/cratd2cchain/eth/bft"
	"github.com/CratD2C-SmartChain/cratd2cchain/eth/downloader"
	"github.com/CratD2C-SmartChain/cratd2cchain/eth/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkID uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb ethdb.Database) (*ProtocolManager, error) {
	...
	if config.CratD2C != nil {
		handleProposedBlock = func(header *types.Header) error {
			return engine.(*CratD2C.CratD2C).HandleProposedBlock(blockchain, header)
		}
	} else {
		handleProposedBlock = func(header *types.Header) error {
			return nil
	...
	if blockchain.Config().CratD2C != nil {
